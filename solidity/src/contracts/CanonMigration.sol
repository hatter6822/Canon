...
contract CanonMigration is ICanonMigration {
    // ------------------------------------------------------------------
    // Custom errors
    // ------------------------------------------------------------------
    ...
    ///         attestor key.
    ///
    /// @param _predecessor              the old `CanonBridge`
    /// @param _successor                the new `CanonBridge` (must
    ...
    constructor(
        ...
        bytes32 _preDid = ICanonBridge(_predecessor).deploymentId();
        ...
        address _attestor = ICanonBridge(_predecessor).attestor();
