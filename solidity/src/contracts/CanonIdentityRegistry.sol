...
///         bridge deployment + a `CanonMigration` handoff (§9.5).
///
...
contract CanonIdentityRegistry is ICanonIdentityRegistry {
    // ------------------------------------------------------------------
    // Custom errors
    // ------------------------------------------------------------------
    ...
    /// @param _canonVersionTag a deployment-namespacing tag used in
    ///        the deploymentId derivation.  Constant for the lifetime
    ///        of this contract.
    constructor(bytes32 _canonVersionTag) {
        deploymentId =
    ...
    /// @inheritdoc ICanonIdentityRegistry
