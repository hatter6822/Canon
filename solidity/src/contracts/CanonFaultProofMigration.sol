...
/// (Workstream E §20) with bidirectional-consent semantics: the
...
contract CanonFaultProofMigration {
    ...
    constructor(
        ...
        // Bidirectional consent: the predecessor must already
        // point at THIS migration contract before activation
        // proceeds; one-sided constructor wiring would allow a
        // hostile migration contract to seize control of a
        // predecessor that never opted in.
        try
